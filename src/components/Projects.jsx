    ...
    return (
        <ScrollReveal>
            <div id='projects' className='flex flex-col items-center gap-8 md:flex-row md:gap-20'>
                <img src={project.cover} alt="" className='w-4/5 cursor-pointer rounded-2xl transition-all duration-300 hover:scale-105 md:w-[300px] object-cover ' onClick={() => {openModal(project)}}/>
